...
console.log("Incomplete Tasks:", incompleteTasks);          // a
console.log("Sorted by Priority:", sortedByPriority);       // b
console.log("All Tasks Completed:", allCompleted);          // c
console.log("Sorted Incomplete Tasks:", sortedIncompleteTasks); // d
